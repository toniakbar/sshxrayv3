...
echo ""
wget -q https://raw.githubusercontent.com/toniakbar/sshxrayv3/main/FILE/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear

echo -e "${tyblue}.------------------------------------------.${NC}"
echo -e "${tyblue}|            PROCESS ADD DOMAIN            |${NC}"
echo -e "${tyblue}'------------------------------------------'${NC}"
echo " "
...
wget https://raw.githubusercontent.com/toniakbar/sshxrayv3/main/FILE/SSH/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
wget https://raw.githubusercontent.com/toniakbar/sshxrayv3/main/FILE/XRAY/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
...
wget https://raw.githubusercontent.com/toniakbar/sshxrayv3/main/FILE/WEBSOCKET/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
wget https://raw.githubusercontent.com/toniakbar/sshxrayv3/main/FILE/OPENVPN/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
#Install AutoBackup
echo -e "${tyblue}.------------------------------------------.${NC}"
...
wget https://raw.githubusercontent.com/toniakbar/sshxrayv3/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
#Download Extra Menu
echo -e "${tyblue}.------------------------------------------.${NC}"
...
wget https://raw.githubusercontent.com/toniakbar/sshxrayv3/main/FILE/MENU/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/toniakbar/sshxrayv3/main/FILE/version  )
...
echo -e " ${tyblue}'------------------------------------------'${NC}"
echo ""
echo -e "   ${tyblue}Your VPS Will Be Automatical Reboot In 5 seconds${NC}"
